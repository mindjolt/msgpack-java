...
import com.jamcity.msgpack.template.Templates;
...
public class TestMessagePack01 {
    ...
    public static class TestBigIntegerBufferPackBufferUnpack extends TestSet {
	@Test @Override
    ...
    public static class TestBigIntegerBufferPackConvert extends TestSet {
	@Test @Override
	public void testBigInteger() throws Exception {
	    super.testBigInteger();
	}
    ...
    public static class TestBigIntegerBufferPackUnpack extends TestSet {
	@Test @Override
	public void testBigInteger() throws Exception {
	    super.testBigInteger();
	}
    ...
    public static class TestBigIntegerPackBufferUnpack extends TestSet {
	@Test @Override
	public void testBigInteger() throws Exception {
	    super.testBigInteger();
	}
    ...
    public static class TestBigIntegerPackConvert extends TestSet {
	@Test @Override
	public void testBigInteger() throws Exception {
	    super.testBigInteger();
	}
    ...
    public static class TestBigIntegerPackUnpack extends TestSet {
	@Test @Override
	public void testBigInteger() throws Exception {
	    super.testBigInteger();
	}
    ...
    public static class TestBigIntegerUnconvertConvert extends TestSet {
	@Test @Override
	public void testBigInteger() throws Exception {
	    super.testBigInteger();
	}
    ...
    public static class TestStringBufferPackBufferUnpack extends TestSet {
	@Test @Override
    ...
    public static class TestStringBufferPackConvert extends TestSet {
	@Test @Override
	public void testString() throws Exception {
	    super.testString();
	}
    ...
    public static class TestStringBufferPackUnpack extends TestSet {
	@Test @Override
	public void testString() throws Exception {
	    super.testString();
	}
    ...
    public static class TestStringPackBufferUnpack extends TestSet {
	@Test @Override
	public void testString() throws Exception {
	    super.testString();
	}
    ...
    public static class TestStringPackConvert extends TestSet {
	@Test @Override
	public void testString() throws Exception {
	    super.testString();
	}
    ...
    public static class TestStringPackUnpack extends TestSet {
	@Test @Override
	public void testString() throws Exception {
	    super.testString();
	}
    ...
    public static class TestStringUnconvertConvert extends TestSet {
	@Test @Override
	public void testString() throws Exception {
	    super.testString();
	}
    ...
    public static class TestByteArrayBufferPackBufferUnpack extends TestSet {
	@Test @Override
    ...
    public static class TestByteArrayBufferPackConvert extends TestSet {
	@Test @Override
	public void testByteArray() throws Exception {
	    super.testByteArray();
	}
    ...
    public static class TestByteArrayBufferPackUnpack extends TestSet {
	@Test @Override
	public void testByteArray() throws Exception {
	    super.testByteArray();
	}
    ...
    public static class TestByteArrayPackBufferUnpack extends TestSet {
	@Test @Override
	public void testByteArray() throws Exception {
	    super.testByteArray();
	}
    ...
    public static class TestByteArrayPackConvert extends TestSet {
	@Test @Override
	public void testByteArray() throws Exception {
	    super.testByteArray();
	}
    ...
    public static class TestByteArrayPackUnpack extends TestSet {
	@Test @Override
	public void testByteArray() throws Exception {
	    super.testByteArray();
	}
    ...
    public static class TestByteArrayUnconvertConvert extends TestSet {
	@Test @Override
	public void testByteArray() throws Exception {
	    super.testByteArray();
	}
    ...
    public static class TestListBufferPackBufferUnpack extends TestSet {
	@Test @Override
	...
	public <E> void testList(List<E> v, Class<E> elementClass) throws Exception {
	    ...
	    byte[] bytes = msgpack.write(v, Templates.tList(tElm));
	    List<E> ret = msgpack.read(bytes, new ArrayList<E>(), Templates.tList(tElm));
	    if (v == null) {
    ...
    public static class TestListBufferPackUnpack extends TestSet {
	@Test @Override
	public void testList() throws Exception {
	    super.testList();
	}
	...
	public <E> void testList(List<E> v, Class<E> elementClass) throws Exception {
	    ...
	    byte[] bytes = msgpack.write(v, Templates.tList(tElm));
	    ByteArrayInputStream in = new ByteArrayInputStream(bytes);
	    List<E> ret = msgpack.read(in, new ArrayList<E>(), Templates.tList(tElm));
	    if (v == null) {
		assertEquals(null, ret);
		return;
	    }
    ...
    public static class TestListPackBufferUnpack extends TestSet {
	@Test @Override
	public void testList() throws Exception {
	    super.testList();
	}
	...
	public <E> void testList(List<E> v, Class<E> elementClass) throws Exception {
	    ...
	    ByteArrayOutputStream out = new ByteArrayOutputStream();
	    Template<E> tElm = msgpack.lookup(elementClass);
	    msgpack.write(out, v, Templates.tList(tElm));
	    byte[] bytes = out.toByteArray();
	    List<E> ret = msgpack.read(bytes, Templates.tList(tElm));
	    if (v == null) {
		assertEquals(null, ret);
		return;
	    }
    ...
    public static class TestListPackUnpack extends TestSet {
	@Test @Override
	public void testList() throws Exception {
	    super.testList();
	}
    ...
    public static class TestMapBufferPackBufferUnpack extends TestSet {
	@Test @Override
	...
	public <K, V> void testMap(Map<K, V> v, Class<K> keyElementClass, Class<V> valueElementClass) throws Exception {
	    ...
	    byte[] bytes = msgpack.write(v, Templates.tMap(tKey, tValue));
	    Map<K, V> ret = msgpack.read(bytes, new HashMap<K, V>(), Templates.tMap(tKey, tValue));
	    if (v == null) {
		assertEquals(null, ret);
		return;
	    }
    ...
    public static class TestMapBufferPackUnpack extends TestSet {
	@Test @Override
	public void testMap() throws Exception {
	    super.testMap();
	}
	...
	public <K, V> void testMap(Map<K, V> v, Class<K> keyElementClass, Class<V> valueElementClass) throws Exception {
	    ...
	    byte[] bytes = msgpack.write(v, Templates.tMap(tKey, tValue));
	    ByteArrayInputStream in = new ByteArrayInputStream(bytes);
	    Map<K, V> ret = msgpack.read(in, new HashMap<K, V>(), Templates.tMap(tKey, tValue));
	    if (v == null) {
		assertEquals(null, ret);
		return;
	    }
    ...
    public static class TestMapPackBufferUnpack extends TestSet {
	@Test @Override
	public void testMap() throws Exception {
	    super.testMap();
	}
	...
	public <K, V> void testMap(Map<K, V> v, Class<K> keyElementClass, Class<V> valueElementClass) throws Exception {
	    ...
	    Template<K> tKey = msgpack.lookup(keyElementClass);
	    Template<V> tValue = msgpack.lookup(valueElementClass);
	    msgpack.write(out, v, Templates.tMap(tKey, tValue));
	    byte[] bytes = out.toByteArray();
	    Map<K, V> ret = msgpack.read(bytes, new HashMap<K, V>(), Templates.tMap(tKey, tValue));
	    if (v == null) {
		assertEquals(null, ret);
    ...
    public static class TestMapPackUnpack extends TestSet {
	@Test @Override
	public void testMap() throws Exception {
	    super.testMap();
	}
    ...
    /*:*
     * test pack Value, but compiler recognize it as java.lang.Object
     */
    @Test
