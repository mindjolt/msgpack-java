...
public class TestBooleanArrayTemplate {
	...
	new TestPackUnpack().setIndex(0).testBooleanArray();
    }

    @Test
    public void testPackUnpack01() throws Exception {
	new TestPackUnpack().setIndex(1).testBooleanArray();
    }

    @Test
    public void testPackUnpack02() throws Exception {
	new TestPackUnpack().setIndex(2).testBooleanArray();
    }

    @Test
    public void testPackBufferUnpack00() throws Exception {
	new TestPackBufferUnpack().setIndex(0).testBooleanArray();
    }

    @Test
    public void testPackBufferUnpack01() throws Exception {
	new TestPackBufferUnpack().setIndex(1).testBooleanArray();
    }

    @Test
    public void testPackBufferUnpack02() throws Exception {
	new TestPackBufferUnpack().setIndex(2).testBooleanArray();
    }

    @Test
    public void testBufferPackBufferUnpack00() throws Exception {
	new TestBufferPackBufferUnpack().setIndex(0).testBooleanArray();
    }

    @Test
    public void testBufferPackBufferUnpack01() throws Exception {
	new TestBufferPackBufferUnpack().setIndex(1).testBooleanArray();
    }

    @Test
    public void testBufferPackBufferUnpack02() throws Exception {
	new TestBufferPackBufferUnpack().setIndex(2).testBooleanArray();
    }

    @Test
    public void testBufferPackUnpack00() throws Exception {
	new TestBufferPackUnpack().setIndex(0).testBooleanArray();
    }

    @Test
    public void testBufferPackUnpack01() throws Exception {
	new TestBufferPackUnpack().setIndex(1).testBooleanArray();
    }

    @Test
    public void testBufferPackUnpack02() throws Exception {
	new TestBufferPackUnpack().setIndex(2).testBooleanArray();
    }
